...
var KakoRestraurant = new Restraurant('Kako Restraurant', location4);
...
var kitchenmanagement = new KitchenManagement();
var ordermanagement = new OrderManagement();
var paymentmanagement = new PaymentManagement();
var bookingManagement = new BookingManagement();
var tablemanagement = new TableManagement_1.TableManagement();
var personManagement = new PersonManagement();
...
var insideorder1 = new Insideorder(1, OrderCategory.INSIDE_ORDER, date1, waiter2, lin);
var insideorder2 = new Insideorder(2, OrderCategory.INSIDE_ORDER, date1, banana, chorkev);
var insideorder3 = new Insideorder(3, OrderCategory.INSIDE_ORDER, date3, banana, seavheng);
var insideorder4 = new Insideorder(4, OrderCategory.INSIDE_ORDER, date5, banana, seavheng);
var outsideorder1 = new Outsideorder(1, OrderCategory.OUTSIDE_ORDER, date2, nora);
var outsideorder2 = new Outsideorder(2, OrderCategory.OUTSIDE_ORDER, date2, shika);
var outsideorder3 = new Outsideorder(3, OrderCategory.OUTSIDE_ORDER, date3, romdual);
var pay1 = new Paydirectmoney(5, insideorder1);
var pay2 = new Paybybankaccount("200 090 333", 5, outsideorder1);
var pay3 = new Paydirectmoney(5, insideorder2);
var pay4 = new Paydirectmoney(5, insideorder3);
var pay5 = new Paydirectmoney(5, insideorder4);
