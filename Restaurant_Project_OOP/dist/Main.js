...
var insideorder1 = new Orderinside_1.Insideorder(1, Ordercategory_1.OrderCategory.INSIDE_ORDER, waiter2, lin);
var insideorder2 = new Orderinside_1.Insideorder(2, Ordercategory_1.OrderCategory.INSIDE_ORDER, banana, chorkev);
var insideorder3 = new Orderinside_1.Insideorder(3, Ordercategory_1.OrderCategory.INSIDE_ORDER, banana, seavheng);
var insideorder4 = new Orderinside_1.Insideorder(4, Ordercategory_1.OrderCategory.INSIDE_ORDER, banana, seavheng);
var outsideorder1 = new Orderoutside_1.Outsideorder(1, Ordercategory_1.OrderCategory.OUTSIDE_ORDER, date1, nora);
...
var booking1 = new Booking_1.Booking(2, 10, romdual, date1, date1Arried);
